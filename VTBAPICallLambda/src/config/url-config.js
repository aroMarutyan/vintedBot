export const SEARCH_URL = new URL('https://www.vinted.com/api/v2/catalog/items');
...
HEADERS.append('Origin', 'https://www.vinted.com');
HEADERS.append('Referer', 'https://www.vinted.com/');
